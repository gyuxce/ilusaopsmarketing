...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-sm font-black text-[#141414] uppercase tracking-wider mb-1">{title}</h3>
      <p className="text-[11px] text-slate-500 normal-case font-medium max-w-sm leading-normal mb-6">{description}</p>
      {actionText && onAction && (
        <button
          onClick={onAction}
